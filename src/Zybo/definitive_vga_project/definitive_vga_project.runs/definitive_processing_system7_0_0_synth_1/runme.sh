...
HD_PWD='C:/Users/user2/Documents/Vivado/definitive_vga_project/definitive_vga_project.runs/definitive_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log definitive_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source definitive_processing_system7_0_0.tcl
