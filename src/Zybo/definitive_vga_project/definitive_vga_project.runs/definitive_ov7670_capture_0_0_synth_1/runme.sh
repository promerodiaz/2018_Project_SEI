...
HD_PWD='C:/Users/user2/Documents/Vivado/definitive_vga_project/definitive_vga_project.runs/definitive_ov7670_capture_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log definitive_ov7670_capture_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source definitive_ov7670_capture_0_0.tcl
