...
HD_PWD='C:/Users/user2/Documents/Vivado/definitive_vga_project/definitive_vga_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log definitive_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source definitive_wrapper.tcl -notrace
