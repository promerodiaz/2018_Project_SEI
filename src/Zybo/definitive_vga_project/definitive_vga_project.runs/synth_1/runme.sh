...
HD_PWD='C:/Users/user2/Documents/Vivado/definitive_vga_project/definitive_vga_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log definitive_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source definitive_wrapper.tcl
