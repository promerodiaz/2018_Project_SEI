...
##LEDs
#set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { gpio_rtl_tri_o[0] }]; #IO_L23P_T3_35 Sch=gpio_rtl_tri_io0
#set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { gpio_rtl_tri_o[1] }]; #IO_L23N_T3_35 Sch=gpio_rtl_tri_io1
#set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { gpio_rtl_tri_o[2] }]; #IO_0_35=Sch=gpio_rtl_tri_io2
#set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { gpio_rtl_tri_o[3] }]; #IO_L3N_T0_DQS_AD1N_35 Sch=gpio_rtl_tri_io3
